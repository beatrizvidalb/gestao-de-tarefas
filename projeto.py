...
def adicionar():
    ...
    prioridade = input("Digite a prioridade da tarefa: ").lower()
    status = input("Digite o status da tarefa: ").lower()
...
def concluir():
    concluir = input("Digite o nome da tarefa que você quer concluir: ").lower()
    qtde_tarefas_concluidas = 0
    for element in lista_de_tarefas:
        if element["Nome"] == concluir:
...
def prioridade():
    prioridade = input("Digite a prioridade das tarefas que você quer ver: ").lower()
    lista_de_prioridade = []
    for element in lista_de_tarefas:
...
def categoria():
    categoria = input("Digite a categoria das tarefas que você quer ver: ").lower()
    lista_de_categoria = []
    for element in lista_de_tarefas:
...
def remover():
    remover = input("Digite o nome da tarefa que você quer remover: ").lower()
